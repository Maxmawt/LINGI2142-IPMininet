...
class BGPTopo2RR4(IPTopo):

    def build(self, *args, **kwargs):
        """
        Topo from slide 42 iBGP YELLOW config
		"""
        # Add all routers
        ...
        set_rr(self, rr=as1r6, peers=[as1r1, as1r2, as1r4, as1r3, as1r5])
        ...
        super(BGPTopo2RR4, self).build(*args, **kwargs)
