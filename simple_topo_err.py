...
class SimpleBGPTopoErr(IPTopo):
    ...
    +-------+         |  +-------+             +-------+  |         +-------+
		...
		self.addLink(as6r1, h1, params1={"ip": "dead:beef:1::/48"}, params2={"ip": "dead:beef:1:1::/48"})
		self.addLink(as6r2, h2, params1={"ip": "dead:beef:1:2::/48"}, params2={"ip": "dead:beef:1:3::/48"})
